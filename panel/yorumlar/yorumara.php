...
$ara = $db->query("Select * from yorumlar where yorum like '%$q%' ");
                    ...
                    <table class="table table-hover table-striped">
                     ...
                     <?php foreach($ara as $ar){ ?>
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="yorumduzenle.php?id=<?php echo $ar["id"]; ?>"><?php echo $ar["adsoyad"]; ?></a></td>
                          <td class="mailbox-subject"><?php echo $ar["yorum"]; ?></td>
                          <td class="mailbox-attachment"><?php echo $ar["email"]; ?></td>
                          <td class="mailbox-attachment"><?php echo $ar["ipadres"]; ?></td>
